...
import { JpaClaimsEntryBase, JpaClaimsEntry, JpaMasterEntry } from './../../../../../models/doi/doiModel';
...
@Component({
  selector: 'app-jpa-pending-approval-listing',
  templateUrl: './jpa-pending-approval-listing.component.html',
  styleUrls: ['./jpa-pending-approval-listing.component.css']
})
export class JpaPendingApprovalListingComponent implements OnInit {
  todayDate = new Date();
  // Form Group
  ...
  ngOnInit() {
    ...
    this.referneceNumber = this.jpaUtilityService.getNewPolicyNumber();
  }
...
public getTaluka(id: number): string {
  ...
  private getMasterSchemeListing(payload: any) {
