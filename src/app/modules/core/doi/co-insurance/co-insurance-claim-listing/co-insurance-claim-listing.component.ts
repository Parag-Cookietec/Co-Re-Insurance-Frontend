 ...
 getInsuredNameList() {
  ...
  fetchAllClaimListing() {
	...
	searchDisplay() {
		...
		let cnt = 0;
		if(this.coInsuranceClaimForm.value.name !== '' && this.coInsuranceClaimForm.value.name !==undefined) {
		  
		  opt[cnt++]= {'key':'name', 'value':this.coInsuranceClaimForm.value.name };
		}
		if(this.coInsuranceClaimForm.value.insuredName !== '' && this.coInsuranceClaimForm.value.insuredName !==undefined) {
		
		  opt[cnt++]= {'key':'insuredName', 'value':this.coInsuranceClaimForm.value.insuredName };
		}
