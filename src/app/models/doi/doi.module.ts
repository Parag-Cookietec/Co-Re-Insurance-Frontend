...
import { DoiRoutingModule } from './../../modules/core/doi/doi-routing.module';
import { JpaClaimEntryComponent, ValidationDialogComponent } from './../../modules/core/doi/jpa/jpa-claim-entry/jpa-claim-entry.component';
import { JpaPendingApprovalListingComponent } from './../../modules/core/doi/jpa/jpa-pending-approval-listing/jpa-pending-approval-listing.component';

import { JpaMasterFromBankBranchComponent } from './../../modules/core/doi/jpa/jpa-master-from-bank-branch/jpa-master-from-bank-branch.component';
import { JpaMasterPolicyComponent } from './../../modules/core/doi/jpa/jpa-master-policy/jpa-master-policy.component';
import { JpaApprovalListingComponent } from './../../modules/core/doi/jpa/jpa-approval-listing/jpa-approval-listing.component';
//import { JpaRejectionListingComponent } from './../../modules/core/doi/jpa/jpa-rejection-listing/jpa-rejection-listing.component';
// import { HbaProposalListComponent } from './hba/hba-proposal/hba-proposal.component';
//import { JpaSendForPaymentListingComponent } from './../../modules/core/doi/jpa/jpa-send-for-payment-listing/jpa-send-for-payment-listing.component';
import { JpaLegalEntryComponent } from './../../modules/core/doi/jpa-legal/jpa-legal-entry/jpa-legal-entry.component';
import { DocumentMasterComponent } from './../../modules/core/doi/jpa/document-master/document-master.component';
import { JpaLegalListingComponent } from './../../modules/core/doi/jpa-legal/jpa-legal-listing/jpa-legal-listing.component';
// import { DeadStockRegisterComponent } from './account-admin/dead-stock-register/dead-stock-register.component';
// import { ChallanRegisterPrintComponent } from './account-admin/challan-register/challan-register.component';
...
import { JpaLegalEntryForRequestListingComponent } from './../../modules/core/doi/jpa-legal/jpa-legal-entry-for-request-listing/jpa-legal-entry-for-request-listing.component';
import { JpaLegalEntryForRequestComponent } from './../../modules/core/doi/jpa-legal/jpa-legal-entry-for-request/jpa-legal-entry-for-request.component';
...
//import { ClaimNoteComponent } from './../../modules/core/doi/jpa/jpa-report/claim-note/claim-note.component';
//import { MemorandumComponent } from './../../modules/core/doi/jpa/jpa-report/memorandum/memorandum.component';
import { NoClaimComponent } from './../../modules/core/doi/jpa/jpa-report/no-claim/no-claim.component';
import { QueryGenerateComponent } from './../../modules/core/doi/jpa/jpa-report/query-generate/query-generate.component';
import { WorkflowDoiComponent } from './../../modules/core/doi/workflow-doi/workflow-doi.component';
import { JpaQueryDialogComponent } from './../../modules/core/doi/jpa/jpa-query-dialog/jpa-query-dialog.component';
import { JpaRejectionQueryDialogComponent } from './../../modules/core/doi/jpa/jpa-rejection-query-dialog/jpa-rejection-query-dialog.component';
import { JpaClaimEntryViewComponent } from './../../modules/core/doi/jpa/jpa-claim-entry-view/jpa-claim-entry-view.component';
...
// mport { ClaimEntryListingApplicationAcceptedComponent } from './direct-business/claim-entry-listing-application-accepted/claim-entry-listing-application-accepted.component';
...
import { WorkflowDoiModuleComponent } from './../../modules/core/doi/workflow-doi-module/workflow-doi-module.component';
...
import { DocumentDialogComponent } from './../../modules/core/doi/jpa/jpa-claim-entry/document-dialog/document-dialog.component';
// import { BtrFiveReportComponent } from './account-admin/btr-five/btr-five-report/btr-five-report.component';
import { JpaLegalClaimListingComponent } from './../../modules/core/doi/jpa-legal/jpa-legal-claim-listing/jpa-legal-claim-listing.component';
...
import { JpaClaimEntryEditComponent } from './../../modules/core/doi/jpa/jpa-claim-entry-edit/jpa-claim-entry-edit.component';
